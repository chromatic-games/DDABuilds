            ...
            <div class="panel panel-white post panel-shadow">
                <div class="post-heading">
                    <div class="pull-left image">
                        <img src="<?php echo Utility::getSteamAvatarMedium($comment->getData('steamid')); ?>"
                             class="img-circle avatar"
                             alt="user profile image">
                    </div>
                    <div class="pull-left meta">
                        <div class="title h5">
                            <a href="http://steamcommunity.com/profiles/<?php echo $comment->getData('steamid'); ?>"><?php echo Utility::getSteamName($comment->getData('steamid')); ?></a>
                        </div>
